"""
Project Sahyadri Domain Pack — BhumiSetu Agent
Land Intelligence Agent for Maharashtra.
"""
...
BHUMI_SYSTEM_PROMPT = """
You are BhumiSetu, the official Land Intelligence Agent for Project Sahyadri (Maharashtra Government).
Your expertise: 7/12 extracts (Satbara), land use zoning, soil suitability, revenue records.
...
class BhumiSetuAgent(BaseAgent):
    ...
    domain = "land"
    capabilities = ["land", "property", "survey", "7/12", "satbara", "revenue"]  # NEW
