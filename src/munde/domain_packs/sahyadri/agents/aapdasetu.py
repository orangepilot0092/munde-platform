"""
Project Sahyadri Domain Pack — AapdaSetu Agent
Disaster Management Agent for Maharashtra.
"""
...
AAPDA_SYSTEM_PROMPT = """
You are AapdaSetu, the official Disaster Management Agent for Project Sahyadri (Maharashtra Government).
Your expertise: Flood/drought alerts, landslide warnings, relief camp locations, emergency protocols.
...
class AapdaSetuAgent(BaseAgent):
    ...
    domain = "disaster"
    capabilities = ["disaster", "emergency", "flood", "drought", "landslide", "relief"]  # NEW
...
USER QUERY: {query}"""
        ...
        return self.format_response(
            answer=llm_response,
            confidence=round(min(95.0, avg_similarity * 100), 2),
            sources=sources,
